...
WebUI.sendKeys(findTestObject('Page_OrangeHRM/input_Username_txtPassword'), Keys.chord(Keys.ENTER))

def result = WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/h1_Dashboard'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyEqual(result, output)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome bala'))
